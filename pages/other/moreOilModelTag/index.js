  ...
  addChooseTag: function() { //点击确定添加标签
    for (var i in this.data.more) {
      if (this.data.more[i].isChecked == true) {
        var name = this.data.more[i];
        name.name1 = this.data.more[i].dicName + "_chw_" + app.globalData.arr2[i]; //  重复标签name使用_chw_进行分隔
        // name.name1 = this.data.more[i].dicName + app.globalData.arr2[i];
        console.log("==============之前app.globalData.addMoreMes==================");
        console.log(app.globalData.addMoreMes);
        console.log("==============name==================");
        console.log(name);
        console.log("name.isChecked = " + name.isChecked);
        app.globalData.addMoreMes.push(name);
        console.log("app.globalData.addMoreMes[0].isChecked = " + app.globalData.addMoreMes[0].isChecked);
        console.log("==============之后app.globalData.addMoreMes==================");
        console.log(app.globalData.addMoreMes);
